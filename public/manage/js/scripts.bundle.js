    ...
    return {
        init: function () {
            ...
            /*(document.querySelector("#kt_sidebar_theme_mode_toggle").addEventListener("change", (() => {
                "light" === KTThemeMode.getMode() ? KTThemeMode.setMode("dark") : KTThemeMode.setMode("light")
            })), null !== (e = document.querySelector("#kt_app_sidebar_menu_wrapper"))) && (e && (t = e.querySelector(".menu-link.active")) && !0 !== KTUtil.isVisibleInContainer(t, e) && e.scroll({
