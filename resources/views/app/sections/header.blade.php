...
<div id="kt_app_header" class="app-header "
     data-kt-sticky="true" data-kt-sticky-activate="{default: true, lg: true}" data-kt-sticky-name="app-header-sticky" data-kt-sticky-offset="{default: '200px', lg: '300px'}"
>
    ...
    <div class="app-container  container-fluid d-flex flex-stack " id="kt_app_header_container">
        ...
        <div class="d-flex d-lg-none align-items-center me-lg-20 gap-1 gap-lg-2">
            ...
            <div class="btn btn-icon btn-color-gray-500 btn-active-color-primary w-35px h-35px d-flex d-lg-none" id="kt_app_sidebar_toggle">
                <i class="ki-outline ki-abstract-14 lh-0 fs-1"></i>	</div>
            <!--end::Mobile toggle-->
            ...
            <div class="app-page-title d-flex flex-column gap-1 me-3 mb-5 mb-lg-0"  data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_wrapper'}" >
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 mb-2">
                    ...
                    <li class="breadcrumb-item text-gray-600 fw-bold lh-1">
                        <a href="/metronic8/demo63/index.html" class="text-gray-700 text-hover-primary me-1">
                    ...
                    >
                        ...
                        <div class="d-flex align-items-center" data-kt-search-element="toggle" id="kt_header_search_toggle">
                            <div class="btn btn-icon rounded-circle w-35px h-35px bg-light-info border border-info-clarity">
                                <i class="ki-outline ki-magnifier text-info fs-3"></i>                    </div>
                        </div>
                        <!--end::Search toggle-->
        ...
        <i class="ki-outline ki-cross fs-2 fs-lg-1 me-0"></i>    </span>
            ...
            <span class="form-check-label text-gray-700 fs-6 fw-semibold ms-0 me-2">
                ...
                <div class="app-navbar-item">
                    <!--begin::Menu- wrapper-->
                    <div class="btn btn-icon rounded-circle w-35px h-35px bg-light-warning border border-warning-clarity" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" id="kt_menu_item_wow">
                        <i class="ki-outline ki-notification-on text-warning fs-3"></i>        </div>
 ...
 fs-2 text-info"></i>
                ...
                <div class="app-navbar-item">
                    ...
                    <div class="btn btn-icon rounded-circle w-35px h-35px bg-light-primary border border-primary-clarity" id="kt_drawer_chat_toggle">
                        <i class="ki-outline ki-message-text-2 text-primary fs-3"></i>        </div>
                    <!--end::Menu wrapper-->
                </div>
                <!--end::Chat-->
                ...
                <div class="app-navbar-item">
                    <!--begin::Menu wrapper-->
                    <div class="btn btn-icon rounded-circle w-35px h-35px bg-light-success border border-success-clarity" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <i class="ki-outline ki-element-11 text-success fs-3"></i>        </div>
                ...
                <div class="app-navbar-item ms-lg-5" id="kt_header_user_menu_toggle">
                    ...
                    >
                        ...
                        <div class="text-end d-none d-sm-flex flex-column justify-content-center me-3">
                            <span class="#" class="text-gray-500 fs-8 fw-bold">{{Str::limit(\Illuminate\Support\Facades\Auth::user()->email ?? '#',12)}}</span>
                            ...
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">
                                        {{Str::limit(auth()->user()->name ?? '#',16)}}                    <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span>
                                    </div>

                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">
                                        {{Str::limit(auth()->user()->email ?? '#',20)}}                </a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
